...
import com.example.juegogato.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void verificarJugada() {
        ...
        if (!hayGanador && contadorJugadas == 9) {
            Toast.makeText(MainActivity.this, "Ha sido un empate, reinicie el juego", Toast.LENGTH_LONG).show();
        }
    }
    ...
    private void verificarGanador(int total) {
        ...
        if (total == 6) {
            hayGanador = true;
            Toast.makeText(MainActivity.this, "Ganó la X", Toast.LENGTH_LONG).show();
            desahabilitarBotones();
        } else if (total == 99) {
            hayGanador = true;
            Toast.makeText(MainActivity.this, "Ganó la O", Toast.LENGTH_LONG).show();
            desahabilitarBotones();
        }
